...
export default function NavbarCopy() {
  ...
  const [currentService, setCurrentService] = React.useState(services[0].name);
              ...
              <SheetClose asChild>
                <Sheet>
                  <SheetTrigger asChild>
                    <Button variant="outline" className="w-full">
                      Browse Agencies <ChevronRight className="ml-2 h-4 w-4" />
                    </Button>
                  </SheetTrigger>
                  <SheetContent side="left" aria-describedby={undefined}>
                    <SheetHeader>
                      <SheetTitle>Browse Agencies</SheetTitle>
                    </SheetHeader>
                    <div className="flex flex-col space-y-3 mt-[1rem]">
                      <SheetClose asChild>
                        <Sheet open={open} onOpenChange={setOpen}>
                          ...
                          >
                            <SheetHeader>
                              <SheetTitle>Browse Place</SheetTitle>
                            </SheetHeader>
                            <div className="flex flex-col space-y-3 mt-[1rem]">
                              <SheetClose asChild>
                                <Sheet>
                                  ...
                                  >
                                    ...
                                    <div className="flex flex-col space-y-3 mt-[1rem]">
                                      {countries.map((country) => (
                                        <SheetClose asChild key={country}>
                                          <Link
                              ...
                              <SheetClose asChild>
                                <Sheet>
                                  ...
                                  <SheetContent side="left">
                                    <SheetHeader>
                                      <SheetTitle>States</SheetTitle>
                                    </SheetHeader>
                                    <div className="flex flex-col space-y-3 mt-[1rem]">
                                      {states.map((state) => (
                                        <SheetClose asChild key={state}>
                                          <Link
                      ...
                      <div className="py-4">
                        {services.map((service) => {
                          ...
                          return (
                            <div
                              key={service.name}
                              onClick={() => setCurrentService(service.name)}
                            >
                              <Link
                                href="#"
                                className={
                  ...
                  <div className="px-6 py-2 bg-gray-50 dark:bg-gray-700 border-t dark:border-gray-600">
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        Put location aside and browse all Lead Generation
                        agencies.
                      </p>
